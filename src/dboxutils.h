...
static int __scandepth(const char  * __restrict__ _Nonnull root_path , 
                         const char  * __restrict__ _Nonnull  dirent, 
                         char ** __restrict__ _Nonnull collections,
                         new_filter_t  _Nullable custom_filter)  ;
